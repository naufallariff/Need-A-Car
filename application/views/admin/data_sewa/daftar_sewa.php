                        ...
                        <div class="card-body table-responsive">
                            ...
                            <table class="table table-hover text-nowrap text-center table-responsive">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                    <td>
                                        <a class="btn btn-danger btn-sm" href="<?= base_url('index.php') . '/Admin/Data_sewa/delete?id=' . $obj->id ?>" onclick="if(!confirm('Anda yakin akan menghapus data sewa <?= ucwords($nama) ?>?')) {return false}"><i class="bi bi-trash"></i> Delete</a>
                                    </td>
                                    <?php
                                        }
                                    ?>
